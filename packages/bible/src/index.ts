 ...
 *
 * Three providers behind one port, tried widest-coverage first:
 * API.Bible for the long tail of languages, then our own database as the floor
 * that cannot go down. See ADR 6 for the licensing constraints — only
 * public-domain text may be self-hosted, and the loader refuses anything not
